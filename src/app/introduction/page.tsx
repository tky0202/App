  ...
  return (
    <>
      ...
      <div className={styles.container}>
        ...
        お酒を楽しむのが大好きです。また、息子と一緒にお出かけしたり、家族で旅行に行くことも大好きです。家族との時間を大切にしている普通のサラリーマンです。<br />
        仕事はアルバイトからWEBデザイナーとしてのキャリアをスタートしました。<br />
        制作会社での経験を積んだ後、WEBディレクターとしてキャリアチェンジし、大手企業のプロジェクトに携わりました。その後は事業会社で10年以上toC向けのサービスに従事しています。<br />
